...
Additionally, you will need to have the libpkl library available on your machine.
pkl-swift itself does not ship with libpkl bundled.

For installation, consult the https://pkl-lang.org/main/current/libpkl/index.html#installation[libpkl documentation].
